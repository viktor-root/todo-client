    ...
    <div className="container_comp_about">
        <div className="About">
            <div className="header_comp_about">
                <h2>ViNotes</h2>
                <span>App version: 1.2.28.<br/>Viktor Gogolev Corporation &copy;</span>
            </div>
            <div className="list_comp_about">
            <ul class="social-icons-7">
                <li><a href="https://vk.com/v.gogolev"><i class="fab fa-vk"></i></a></li>
                <li><a href="https://github.com/Timurmurmur"><i class="fab fa-github"></i></a></li>
                ...
                <li><a href="g978501n.beget.tech"><i class="fab fa-chrome"></i></a></li>
            </ul>
            </div>
        </div>
    </div>
